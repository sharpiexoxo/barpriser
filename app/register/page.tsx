    ...
    <div className="min-h-screen flex items-center justify-center bg-surface px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-ink-3 mt-1">Create an account to contribute</p>
        </div>
        <div className="card">
          <form onSubmit={submit} className="flex flex-col gap-4">
            ...
            <div>
              <label className="block text-xs font-medium text-ink-2 mb-1">Password <span className="text-ink-3 font-normal">(min. 6 characters)</span></label>
